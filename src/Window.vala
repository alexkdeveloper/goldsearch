...
namespace Goldsearch {
    ...
    public class Window : Adw.Window {
      ...
      construct {
       ...
       b_1 = new Button();
       b_1.add_css_class("flat");
       b_1.set_child(i_1);
       b_2 = new Button();
       b_2.add_css_class("flat");
       b_2.set_child(i_2);
       b_3 = new Button();
       b_3.add_css_class("flat");
       b_3.set_child(i_3);
       b_4 = new Button();
       b_4.add_css_class("flat");
       b_4.set_child(i_4);
       b_5 = new Button();
       b_5.add_css_class("flat");
       b_5.set_child(i_5);
       b_6 = new Button();
       b_6.add_css_class("flat");
       b_6.set_child(i_6);
       b_7 = new Button();
       b_7.add_css_class("flat");
       b_7.set_child(i_7);
       b_8 = new Button();
       b_8.add_css_class("flat");
       b_8.set_child(i_8);
       b_9 = new Button();
       b_9.add_css_class("flat");
       b_9.set_child(i_9);
       b_1.clicked.connect(() =>{
          show_image(i_1, 1);
       });
